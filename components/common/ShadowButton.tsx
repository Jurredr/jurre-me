...
const ShadowButton: React.FC<Props> = (props) => {
  return (
    ...
    >
      <span className="block -translate-y-[6px] rounded-2xl border-[0.22rem] border-b-[0.12rem] border-black bg-white py-2 px-3 transition-transform group-active:-translate-y-[2px] dark:border-jurredarklighter">
